  ...
  { title: '#', dataIndex: 'rank', width: 48, align: 'center' },
  {
    ...
    render: (_, item) => (
      <Space direction="vertical" size={0}>
        ...
        <StockDetailLink symbol={item.ts_code}>{item.ts_code}</StockDetailLink>
...
const AIStock = () => {
  ...
  const positionColumns = [
    { title: '股票', key: 'stock', width: 150, render: (_, row) => <Space direction="vertical" size={0}><Text strong>{row.name}</Text><StockDetailLink symbol={row.ts_code}>{row.ts_code}</StockDetailLink></Space> },
  ...
  const tradeColumns = [
    ...
    { title: '股票', key: 'stock', width: 140, render: (_, row) => <Space direction="vertical" size={0}><Text strong>{row.name}</Text><StockDetailLink symbol={row.ts_code}>{row.ts_code}</StockDetailLink></Space> },
