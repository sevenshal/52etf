...
app.include_router(a_stock_micro400.router)
app.include_router(a_stock_fund_flow.router)
app.include_router(ai_stock.router)
app.include_router(chan_analysis.router)
app.include_router(db_manager.router)
app.include_router(factor_lab.router)
app.include_router(xueqiu_holdings.router)
app.include_router(eastmoney_holdings.router)
