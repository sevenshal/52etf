...
STRATEGY_SOXL_FEAR = "soxl_fear_strategy"
STRATEGY_A_STOCK_FEAR = "a_stock_fear_strategy"
STRATEGY_VALUATION_SIM = "valuation_sim"
...
def build_netted_target_execution_plan(
    ...
    *,
    ...
    order_timeout_seconds_sequence: Optional[List[int]] = None,
    ...
    demands = _build_demand_rows(
        ...
        execution_policy_fallback={
            ...
            "order_timeout_seconds_sequence": order_timeout_seconds_sequence,
