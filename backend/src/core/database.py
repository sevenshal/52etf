...
class WebAccount(Base):
    ...
    can_view_market = Column(Boolean, nullable=False, default=False)
...
class MarketSignalConfig(Base):
    """市场 tab 选股信号的可配置阈值（净利润断层等），按信号类型各存一份。"""
    __tablename__ = "market_signal_configs"
